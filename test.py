# Any changes to the gaussian_binomial_distributions library should be reinstalled with
#  pip install --upgrade .
...
from gauss_binomial_statdist import Gaussian
from gauss_binomial_statdist import Binomial
...
class TestGaussianClass(unittest.TestCase):
    ...
    def test_initialization(self): 
        ...
        self.assertEqual(self.gaussian.standard_deviation, 2, 'incorrect standard deviation')
    ...
    def test_stdevcalculation(self):
        self.assertEqual(round(self.gaussian.calculate_standard_deviation(), 2), 92.87, 'sample standard deviation incorrect')
        self.assertEqual(round(self.gaussian.calculate_standard_deviation(0), 2), 88.55, 'population standard deviation incorrect')

    def test_pdf(self):
        self.assertEqual(round(self.gaussian.pdf(25), 5), 0.19947,\
         'pdf function does not give expected result') 
        self.gaussian.calculate_mean()
        self.gaussian.calculate_standard_deviation()
        self.assertEqual(round(self.gaussian.pdf(75), 5), 0.00429,\
        'pdf function after calculating mean and standard_deviation does not give expected result')
    ...
    def test_add(self):
        ...
        self.assertEqual(gaussian_sum.standard_deviation, 5)
...
class TestBinomialClass(unittest.TestCase):
    ...
    def test_calculatestdev(self):
        stdev = self.binomial.calculate_standard_deviation()
